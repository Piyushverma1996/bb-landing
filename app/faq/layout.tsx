...
export default function FaqLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className={`${playfair.variable} ${montserrat.variable} min-h-screen`} style={{ background: "linear-gradient(160deg,#FBF4EA 0%,#FCFBF7 40%,#F3EFE6 100%)", fontFamily: "var(--font-montserrat), sans-serif", color: "#1A5A54" }}>
      <header className="sticky top-0 z-40 border-b border-[#C9A55C]/20 bg-[#FBF4EA]/85 backdrop-blur">
        <div className="mx-auto flex max-w-3xl items-center justify-between px-5 py-3">
          ...
          <nav className="flex items-center gap-3.5 text-[11.5px] font-semibold sm:gap-4">
            ...
            <Link href="/gallery" className="text-[#1A5A54]/70 hover:text-[#1A5A54]">Gallery</Link>
