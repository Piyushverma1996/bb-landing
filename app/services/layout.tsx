    ...
    >
      <header className="sticky top-0 z-40 border-b border-[#C9A55C]/20 bg-[#FBF4EA]/85 backdrop-blur">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-5 py-3">
          ...
          <nav className="flex items-center gap-3.5 text-[11.5px] font-semibold sm:gap-4">
            ...
            <Link href="/blog" className="text-[#1A5A54]/70 hover:text-[#1A5A54]">Journal</Link>
      ...
      <footer className="mt-16 border-t border-[#C9A55C]/20 py-8 text-center text-[11px] text-[#1A5A54]/60">
        ...
        <p className="mt-2 flex flex-wrap justify-center gap-3">
          <Link href="/services/bridal-makeup" className="hover:text-[#C9A55C]">Bridal Makeup</Link>
          <Link href="/services/party-makeup" className="hover:text-[#C9A55C]">Party Makeup</Link>
          <Link href="/services/nail-extensions" className="hover:text-[#C9A55C]">Nail Extensions</Link>
          <Link href="/services/beauty-services" className="hover:text-[#C9A55C]">Beauty</Link>
          <Link href="/blog" className="hover:text-[#C9A55C]">Journal</Link>
        </p>
      </footer>
    </div>
  );
