...
export const GUIDES: Guide[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { p: "A reliable studio holds strong ratings in multiple places. Blushes & Brushes, for example, holds 4.8★ on Google from 200+ brides and 5.0 across 108 ratings on Justdial. Consistency across independent platforms is hard to fake." },
    ...
    faq: [
      { q: "Who is the best makeup artist in West Delhi?", a: "Shortlist by cross-platform ratings, real-client photos and a trial. Blushes & Brushes by Urvashi Trehan (Ramesh Nagar) is among West Delhi's top-rated - 4.8★ on Google and 5.0 on Justdial (108 ratings) - serving bridal, party, nails and beauty." },
  ...
  },
  {
    ...
    description:
      "How to choose the best nail salon in West Delhi - hygiene, gel vs acrylic, prices - plus a top pick in Ramesh Nagar: gel extensions from ₹500 with free nail art at Blushes & Brushes.",
    ...
    intro: [
      ...
      "Blushes & Brushes in Ramesh Nagar is one option (currently ₹500 for gel extensions with free nail art) - the hygiene checklist below applies wherever you go.",
    ],
    sections: [
      ...
      { ul: [
        "Gel extensions: ₹500–1,500 (Blushes & Brushes: from ₹500 with free nail art)",
      ...
      { p: "Gel extensions from ₹500 with complimentary nail art, plus French, ombré and chrome designer sets - with sanitised tools and careful application that keeps your natural nails healthy. Studio at B 1/1 Double Storey, opposite Subway, Ramesh Nagar." },
    ],
    faq: [
      { q: "Which is the best nail salon in West Delhi?", a: "Choose by hygiene (sterilised tools), careful application and honest pricing. In Ramesh Nagar, Blushes & Brushes offers gel extensions from ₹500 with free nail art, plus French, ombré and chrome designs." },
      { q: "How much do nail extensions cost in West Delhi?", a: "₹500–1,500 for gel extensions depending on design. Blushes & Brushes in Ramesh Nagar currently offers them from ₹500 with complimentary nail art; designer sets from ₹1,500." },
    ...
    ctaLine: "Want the ₹500 nail offer? Message us on WhatsApp to book.",
  },
  {
    ...
    sections: [
      ...
      { ul: [
        "Check cross-platform ratings (Google + Justdial), not just one profile.",
      ...
      { ul: [
        ...
        "Nails: ₹500+ · Facials & beauty: ₹499–1,499",
      ] },
