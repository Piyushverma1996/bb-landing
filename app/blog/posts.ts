...
export const POSTS: Post[] = [
  ...
  {
    slug: "pre-wedding-skincare-routine-30-60-90-days",
    title: "Pre-Wedding Skincare Routine: A 30-60-90 Day Countdown",
    description:
      "The pre-wedding skincare routine a Delhi bridal MUA actually recommends — what to do 90, 60 and 30 days out so your skin glows under makeup on the day.",
    category: "Tips",
    date: "2026-07-23",
    readMins: 6,
    cover: "/images/new-natural.webp",
    ...
    body: [
      ...
      { h: "90 days out — build the foundation" },
      { ul: [
        "Start a consistent AM/PM routine if you don't have one: gentle cleanser, hydrating serum, moisturiser, SPF every single day.",
        "Book a monthly facial — but stick to one trusted place, don't experiment across salons this close to the wedding.",
        "Increase water intake and cut down on late nights where you can. Skin texture responds to sleep faster than to any product.",
        "If you have a specific concern (acne, pigmentation, dullness), see a dermatologist now — 90 days is enough time for real treatments to show results; 30 days is not.",
      ] },
      { h: "60 days out — treat, don't experiment" },
      { ul: [
        "Continue monthly facials, now also add a hydrating mask 1-2x/week at home.",
        "This is the LAST safe window to try a new active ingredient (retinol, strong exfoliants) — anything newer than this risks a reaction close to the wedding.",
        "Address body skin too if it'll be visible: de-tan, exfoliation, moisturising routine for arms and back.",
      ] },
      { h: "30 days out — protect the glow" },
      { ul: [
        "Stop all new products. Full stop. Only use what your skin has already tolerated for weeks.",
        "One calming, hydrating facial — nothing aggressive, no fresh peels or extractions this close.",
        "Sleep and hydration matter more now than any product. This is genuinely the highest-ROI habit in the last month.",
      ] },
      { h: "The final week" },
      { ul: [
        "No facials in the last 3-4 days — skin needs to fully settle, not react.",
        "Keep makeup off your face as much as possible so it isn't overworked before the big day.",
        "Hydrate from inside: water, fruits, less salt/sugar — visible in the skin within days.",
      ] },
      { p: "A pre-bridal skin runway pairs perfectly with your makeup trial — book both together at Blushes & Brushes, Ramesh Nagar, and we'll build a facial + makeup timeline around your actual wedding date." },
    ],
    faq: [
      { q: "When should I start my pre-wedding skincare routine?", a: "90 days before the wedding is ideal — enough time for real skin changes to show and for any new products or treatments to be fully tested before the big day." },
      { q: "Can I try a new skincare product close to my wedding?", a: "No — stop introducing new products at least 30 days out. Anything that could cause a reaction (retinol, strong actives, new facials) should be tested by the 60-day mark at the latest." },
      { q: "What's the single most effective pre-wedding skin habit?", a: "Consistent sleep and hydration. It sounds simple, but it visibly outperforms most skincare products in the final month before a wedding." },
    ],
  },
  {
    slug: "bridal-makeup-to-match-lehenga-colour",
    title: "How to Choose Bridal Makeup That Matches Your Lehenga Colour",
    description:
      "Red, maroon, pastel or gold lehenga — how to pick eye, lip and blush shades that complement your bridal outfit instead of fighting it. A Delhi MUA's colour guide.",
    category: "Bridal",
    date: "2026-07-23",
    readMins: 5,
    cover: "/images/new-bridal-red.webp",
    ...
    body: [
      ...
      { h: "Red & maroon lehengas — the classic choice" },
      { p: "Red is warm and saturated, so makeup needs to hold its own without competing. Go for a defined, smoky or bronze eye, a strong contour, and a lip in brick, deep red or berry — never a pale nude, it gets visually lost against the outfit. Gold jewellery-toned highlighter ties it together." },
      { h: "Pastel lehengas (peach, mint, lavender, powder blue)" },
      { p: "Pastels need softness to match, not heavy drama. Think soft rose-gold or terracotta eyes, a flush blush in peach or rose, and a mauve-nude or soft coral lip. Heavy black smoky eyes fight a pastel outfit — keep liner soft and lashes fuller instead of harder lines." },
      { h: "Gold & yellow lehengas" },
      { p: "Warm metallics love warm makeup: bronze-copper eyes, a warm terracotta blush, and a burnt orange or warm brown-red lip. Avoid cool-pink tones here — they visually clash with gold's warmth." },
      { h: "Pink & fuchsia lehengas" },
      { p: "Cooler pinks pair beautifully with a rose or plum eye, a cool-toned blush, and a berry or wine lip. Stay in the same colour family (cool) rather than mixing in warm oranges." },
      { h: "Blue & teal lehengas" },
      { p: "Blues are a striking contrast colour, so makeup can either complement (soft bronze, warm nude lip for balance) or lean into a coordinated smoky navy-grey eye for a more editorial look. Either direction works — this is where personal preference matters most." },
      { h: "Black or dark-toned lehengas" },
      { p: "Dark outfits allow bold makeup — a defined smoky eye, a strong red or deep berry lip, and dramatic lashes read beautifully against black without looking overdone." },
      { h: "The rule that matters more than colour-matching" },
      { p: "Undertone match (warm/cool/neutral skin + outfit) always outranks literal colour-matching. This is exactly what a trial is for — bring your actual lehenga or a clear photo, and we build the look against it in real light, not guesswork." },
      { p: "Book your bridal trial at Blushes & Brushes, Ramesh Nagar — bring your lehenga or jewellery and we'll design the full look around it." },
    ],
    faq: [
      { q: "Should my makeup match my lehenga colour exactly?", a: "No — makeup should complement your outfit's undertone (warm/cool) rather than literally match its colour. A red lehenga doesn't need red eyeshadow; it needs makeup with the right warmth and intensity to hold its own next to the colour." },
      { q: "What makeup suits a pastel lehenga?", a: "Soft, warm tones — rose-gold or terracotta eyes, peach blush, mauve-nude or soft coral lips. Avoid heavy black smoky eyes, which visually overpower a pastel outfit." },
      { q: "What eye makeup works best with a red bridal lehenga?", a: "A defined smoky or bronze eye with strong contour and a brick-red, deep red or berry lip. Pale nude lips tend to get visually lost against red." },
    ],
  },
];
