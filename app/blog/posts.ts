...
export const POSTS: Post[] = [
  ...
  {
    slug: "how-to-become-makeup-artist-in-delhi",
    title: "How to Become a Makeup Artist in Delhi: Courses, Costs & Career Path (2026)",
    description:
      "Want to become a makeup artist in Delhi? Real course costs, what to look for in an academy, how long it takes, and how much you can earn — from a working MUA who trains students.",
    category: "Career",
    date: "2026-07-28",
    readMins: 7,
    cover: "/images/makeup-course.webp",
    keywords: ["how to become a makeup artist in delhi", "makeup artist course delhi", "makeup academy delhi", "makeup artist career india", "makeup course fees delhi"],
    body: [
      { p: "Every month we get messages from women in West Delhi asking the same thing: \"I want to become a makeup artist — where do I start?\" It's a genuinely good career; it's also one where the wrong course wastes ₹50,000 and six months. Here's the honest path, written by someone who both works as a bridal artist and trains students." },
      { h: "Step 1 — Understand what the job actually is" },
      { p: "Being a makeup artist is roughly 50% skill and 50% client handling. You will work early mornings on wedding days, manage nervous brides and their families, carry your own kit across Delhi traffic, and build a business on referrals. If you enjoy the craft AND the people, it's a career with real earning potential. If you only enjoy the craft, freelance work will feel hard." },
      { h: "Step 2 — Choose the right kind of course" },
      { p: "Delhi has hundreds of makeup courses ranging from ₹15,000 to ₹3,00,000. Price does not reliably indicate quality. What matters:" },
      { ul: [
        "Batch size — the single biggest factor. A 20-student batch means you watch; a 5-student batch means you practise. Ask before enrolling.",
        "Live models vs mannequins — you cannot learn skin-reading, colour matching or client comfort on a practice head.",
        "Who actually teaches — many big-name academies are taught by junior instructors, not the founder whose name is on the door. Ask directly.",
        "Kit policy — some courses bundle an expensive kit into the fee. Check whether you're paying for training or for product.",
        "Post-course support — can you come back with questions? Do they help with your first bookings?",
      ] },
      { h: "Step 3 — Know the real costs" },
      { ul: [
        "Course fee: ₹15,000–50,000 for a solid professional course in Delhi (₹20,000 at Blushes & Brushes Academy). Above this you're usually paying for brand name.",
        "Your starter kit: ₹25,000–60,000 depending on whether you buy drugstore-professional or premium lines. You do not need NARS on day one.",
        "Portfolio building: budget for 3–5 free or low-cost shoots to build the images that get you booked.",
      ] },
      { h: "Step 4 — Build the portfolio before you need it" },
      { p: "Your portfolio is your CV. Do friends' functions, offer discounted trial rates, photograph everything in good natural light, and get before/after shots. Ten strong, well-lit real-client photos will get you more bookings than any certificate." },
      { h: "Step 5 — Understand the earning curve" },
      { ul: [
        "Months 1–6: party makeup at ₹1,500–3,000 per client while you build a portfolio and confidence.",
        "Months 6–18: your first bridal clients, typically ₹8,000–15,000 per booking as you establish trust.",
        "Year 2+: established artists in Delhi charge ₹18,000–30,000 per bridal booking. During peak wedding season (Nov–Feb), a booked-out artist can earn a full year's parlour salary in three months.",
      ] },
      { h: "The honest caveat" },
      { p: "This is not passive income and it is not fast. The artists earning well in year two are the ones who did unglamorous work in year one — replying to every DM, showing up early, taking the small bookings. The skill gets you in; the reliability builds the business." },
      { p: "Blushes & Brushes Academy in Ramesh Nagar runs micro-batches of maximum 5 students, taught directly by Urvashi Trehan on live models in a working salon — ₹20,000 per course, with a free trial class before you enrol." },
    ],
    faq: [
      { q: "How much does a makeup artist course cost in Delhi?", a: "A solid professional makeup course in Delhi costs ₹15,000–50,000. At Blushes & Brushes Academy in Ramesh Nagar it's ₹20,000. Above ₹50,000 you are usually paying for brand name rather than better training. Budget an additional ₹25,000–60,000 for your own starter kit." },
      { q: "How long does it take to become a makeup artist?", a: "The core course takes weeks, but reaching confident bridal-level work typically takes 6–18 months of real client practice. Most artists start with party makeup at ₹1,500–3,000 and move to bridal bookings within a year." },
      { q: "Do I need a certificate to work as a makeup artist in India?", a: "There is no legal licensing requirement, so your portfolio matters far more than your certificate. That said, structured training dramatically shortens the learning curve and teaches hygiene and skin-safety practices that protect your clients and reputation." },
      { q: "How much do makeup artists earn in Delhi?", a: "Established independent bridal artists in Delhi charge ₹18,000–30,000 per wedding booking. Beginners typically start with party makeup at ₹1,500–3,000. Peak wedding season (November–February) accounts for a large share of annual income." },
    ],
  },
  {
    slug: "freelance-makeup-artist-vs-salon-delhi",
    title: "Freelance Makeup Artist vs Salon: Which Should You Book in Delhi?",
    description:
      "Booking a freelance MUA or a salon for your wedding in Delhi? An honest comparison of cost, consistency, travel, hygiene and what actually matters on the day.",
    category: "Bridal",
    date: "2026-07-28",
    readMins: 5,
    cover: "/images/bridal-real-2.webp",
    keywords: ["freelance makeup artist vs salon", "should i book a salon or freelance makeup artist", "bridal makeup delhi booking", "makeup artist or parlour for wedding"],
    body: [
      { p: "When you start booking your wedding makeup in Delhi, you'll quickly hit a fork: book a freelance artist who comes to you, or book a salon/studio. Both work — they fail in different ways. Here's the honest comparison from someone who operates as both a studio and a travelling artist." },
      { h: "The core difference" },
      { p: "With a freelance artist you are booking a specific person. With a large salon you are booking an organisation — and the person who actually does your makeup may be assigned on the day. That single distinction drives almost every other difference below." },
      { h: "Where freelance artists win" },
      { ul: [
        "You know exactly who is doing your makeup — the person whose portfolio you liked is the person who arrives.",
        "They come to you, so no travelling to a salon at 5 AM in bridal-wear.",
        "Usually more flexible on timing for early-morning muhurat functions.",
        "Direct communication — you're talking to the artist, not a receptionist relaying messages.",
      ] },
      { h: "Where salons win" },
      { ul: [
        "Backup capacity — if someone falls ill, a salon has other artists. A solo freelancer has no cover.",
        "Multiple people can be done in parallel (bride + mother + sisters) without a two-artist coordination effort.",
        "Fixed premises means easier accountability if something goes wrong.",
        "Often better equipped for hair, nails and beauty under one roof.",
      ] },
      { h: "The hybrid model (what to actually look for)" },
      { p: "The strongest option is usually an artist who has a studio AND travels — you get a named artist with a real address, a physical place for your trial, backup infrastructure, and on-location service on the wedding day. This is how Blushes & Brushes operates: nails and beauty at the Ramesh Nagar studio, bridal and party makeup travelling to your venue across Delhi NCR." },
      { h: "The five questions that matter more than the format" },
      { ul: [
        "Who specifically will do my makeup on the day? (Get the name in writing.)",
        "Can I see that person's recent real-client work?",
        "What's the backup plan if they're unwell?",
        "What exactly is included — hair, draping, lashes, touch-up kit?",
        "What time will they arrive, committed in writing?",
      ] },
      { p: "Honest answers to those five matter far more than whether the business card says \"freelance\" or \"salon\". Book the answer, not the label." },
    ],
    faq: [
      { q: "Is it better to book a freelance makeup artist or a salon for a wedding?", a: "Neither is universally better. Freelancers give you a guaranteed named artist who travels to you; salons offer backup staff and parallel service for the family. The strongest option is often an artist with a studio who also travels — you get a named artist, a physical address for trials, and on-location wedding service." },
      { q: "What should I ask before booking wedding makeup in Delhi?", a: "Ask who specifically will do your makeup on the day, to see that person's recent real-client photos, what the backup plan is if they're unwell, exactly what's included (hair, draping, lashes, touch-up kit), and the committed arrival time in writing." },
      { q: "Do freelance makeup artists cost more than salons?", a: "Not necessarily. In Delhi both established freelancers and studios charge roughly ₹18,000–30,000 for bridal makeup. Very low quotes from either format usually signal older stock or a junior artist doing the work." },
    ],
  },
];
