      ...
      <header className="sticky top-0 z-40 border-b border-[#C9A55C]/20 bg-[#FBF4EA]/85 backdrop-blur">
        <div className="mx-auto flex max-w-4xl items-center justify-between px-5 py-3">
          ...
          <nav className="flex items-center gap-4 text-[12px] font-semibold">
            <Link href="/" className="text-[#1A5A54]/70 hover:text-[#1A5A54]">Home</Link>
            <Link href="/blog" className="text-[#1A5A54]/70 hover:text-[#1A5A54]">Journal</Link>
            <Link href="/book" className="rounded-full px-3.5 py-1.5 text-white" style={{ background: "linear-gradient(135deg,#2E8B83,#C9A55C)" }}>Book Now</Link>
          </nav>
        </div>
      </header>
